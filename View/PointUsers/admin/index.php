...
<thead>
	<tr>
		...
		<th><?php echo $this->Paginator->sort('PointUser.exp_date', array('asc' => $this->BcBaser->getImg('admin/blt_list_down.png', array('alt' => '昇順', 'title' => '昇順')) . ' exp_date', 'desc' => $this->BcBaser->getImg('admin/blt_list_up.png', array('alt' => '降順', 'title' => '降順')) . ' Mail'), array('escape' => false, 'class' => 'btn-direction')) ?></th>
