...
if($this->loadSchema('0.0.1', 'Point', 'point_coupons', $filterType = 'alter')) {
	$this->setUpdateLog('point_coupons テーブルの構造変更に成功しました。');
} else {
	$this->setUpdateLog('point_coupons テーブルの構造変更に失敗しました。', true);
}